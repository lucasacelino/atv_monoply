...
public class Tabuleiro {
    ...
    public Tabuleiro() {
        ...
        espacos.add(new Imposto("Imposto de Renda", 200));
        ...
        espacos.add(new SorteOuReves("Sorte ou Revés 2")); 
        ...
        espacos.add(new Imposto("Imposto de Luxo", 100));
        ...
        espacos.add(new SorteOuReves("Sorte ou Revés 3"));
        ...
        espacos.add(new ParadaLivre("Parada Livre")); 
        espacos.add(new IrParaPrisao("Ir Para a Prisão"));
    }
